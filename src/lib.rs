...
pub struct AppContext<'a> {
    ...
    pub account_base_url: Option<&'a str>,
    pub account_audience: Option<&'a str>,
    pub account_internal_secret: Option<&'a str>,
    pub super_admin_account_ids: Option<&'a str>,
    pub discovery_private_jwk: Option<&'a str>,
    pub discovery_public_jwk: Option<&'a str>,
    pub discovery_key_id: Option<&'a str>,
    pub test_discovery_well_known: Option<&'a str>,
    pub test_discovery_dns_txt: Option<&'a str>,
